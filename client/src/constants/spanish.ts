const esTranslations = {
  ...
  home_window_hint: '> Mostrando tareas y notas actualizadas en las últimas 24 horas, además de tus tareas pendientes de alta prioridad',
  home_window_hint_tasks: '> Mostrando tareas actualizadas en las últimas 24 horas, además de tus tareas pendientes de alta prioridad',
  home_window_hint_notes: '> Mostrando notas actualizadas en las últimas 24 horas',
  home_search_hint: '> Mostrando todos los resultados coincidentes, independientemente de cuándo se actualizaron por última vez',
  ...
  note_form_content_placeholder: 'Escribe algo...',
  note_form_url_placeholder: 'Añadir una URL',
  note_form_tags_placeholder: 'Añadir etiquetas',
