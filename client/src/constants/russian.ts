const ruTranslations = {
  ...
  home_window_hint: '> Показаны задачи и заметки, обновлённые за последние 24 часа, а также невыполненные приоритетные задачи',
  home_window_hint_tasks: '> Показаны задачи, обновлённые за последние 24 часа, а также невыполненные приоритетные задачи',
  home_window_hint_notes: '> Показаны заметки, обновлённые за последние 24 часа',
  home_search_hint: '> Показаны все подходящие результаты независимо от времени последнего обновления',
  ...
  note_form_content_placeholder: 'Напишите что-нибудь...',
  note_form_url_placeholder: 'Добавить URL',
  note_form_tags_placeholder: 'Добавить теги',
