const ptBrTranslations = {
  ...
  home_window_hint: '> Mostrando tarefas e notas atualizadas nas últimas 24 horas, além das suas tarefas pendentes de alta prioridade',
  home_window_hint_tasks: '> Mostrando tarefas atualizadas nas últimas 24 horas, além das suas tarefas pendentes de alta prioridade',
  home_window_hint_notes: '> Mostrando notas atualizadas nas últimas 24 horas',
  home_search_hint: '> Mostrando todos os resultados correspondentes, independentemente de quando foram atualizados',
  ...
  note_form_content_placeholder: 'Escreva algo...',
  note_form_url_placeholder: 'Adicionar uma URL',
  note_form_tags_placeholder: 'Adicionar etiquetas',
